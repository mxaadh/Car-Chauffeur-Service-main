...
class __TwigTemplate_4f908905b39b7775ad882fe9b0caa2f2 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["phone"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["phone"], "manufacturer", [], "any", false, false, false, 25), "html", null, true);
            echo "</a>
                </td>
                <td>
                    <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_phone_show", ["id" => twig_get_attribute($this->env, $this->source, $context["phone"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_phone_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["phone"], "id", [], "any", false, false, false, 29)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  159 => 40,  154 => 37,  145 => 33,  136 => 29,  132 => 28,  124 => 25,  119 => 23,  115 => 22,  111 => 21,  108 => 20,  103 => 19,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
    ...
    <table class=\"table\">
        ...
        {% for phone in phones %}
            <tr>
                ...
                <td>{{ phone.memory }}</td>
                <td>
                    <a href=\"{{ path('app_make_show', {'id': phone.manufacturer.id}) }}\">{{ phone.manufacturer }}</a>
                </td>
                <td>
...
{% endblock %}
", "phone/index.html.twig", "C:\\laragon\\www\\Car-Chauffeur-Service-main\\templates\\phone\\index.html.twig");
    }
}
