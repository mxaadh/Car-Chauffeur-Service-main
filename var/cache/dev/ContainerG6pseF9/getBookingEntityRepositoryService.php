 ...
 */
class getBookingEntityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BookingEntityRepository' shared autowired service.
     *
     * @return \App\Repository\BookingEntityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BookingEntityRepository.php';

        return $container->privates['App\\Repository\\BookingEntityRepository'] = new \App\Repository\BookingEntityRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
